...
#python ~/retroicor/retroicorLauren.py -resp_file physiopy/test001r -card_file physiopy/test001c -prefix test001 -num_slices 33 -volume_tr 2.2 -freq 50  -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -resp_file physiopy/test002r -card_file physiopy/test002c -prefix test002 -num_slices 33 -volume_tr 2.2  -freq 50  -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -phys_file physiopy/test003c.tsv.gz -phys_json physiopy/test003c.json -prefix test003c -num_slices 34 -volume_tr 2.0  -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -phys_file physiopy/test003r.tsv.gz -phys_json physiopy/test003r.json -prefix test003r -num_slices 34 -volume_tr 2.0  -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -phys_file physiopy/test004.tsv.gz -phys_json physiopy/test004.json -prefix test004 -num_slices 34 -volume_tr 2.0  -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -phys_file physiopy/test005.tsv.gz -phys_json physiopy/test005.json -prefix test005 -num_slices 34 -volume_tr 2.0  -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -card_file physiopy/test007c -prefix test007c -num_slices 33 -volume_tr 2.2 -freq 50   -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -card_file physiopy/test008c -prefix test008c -num_slices 33 -volume_tr 2.2 -freq 50   -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -resp_file physiopy/test007r -prefix test007r -num_slices 33 -volume_tr 2.2 -freq 50   -rvt_out 1 -num_time_pts 220   
#python ~/retroicor/retroicorLauren.py -card_file physiopy/sub-005_ses-01_task-rest_run-1_physio-ECG.txt -resp_file physiopy/sub-005_ses-01_task-rest_run-1_physio-Resp.txt -num_slices 33 -volume_tr 2.2 -freq 50   -rvt_out 1 -num_time_pts 220   
#
